...
<?php if ( $email_improvements_enabled ) : ?>
	...
	<?php if ( $password_generated && $set_password_url ) : ?>
		...
		<p><a href="<?php echo esc_attr( $set_password_url ); ?>"><?php echo esc_html__( 'Set your new password.', 'nh-theme' ); ?></a></p>
	<?php endif; ?>
	...
	<p><a href="<?php echo esc_attr( wc_get_page_permalink( 'myaccount' ) ); ?>"><?php echo esc_html__( 'My account', 'nh-theme' ); ?></a></p>
...
<?php else : ?>
	...
	<p>
		<?php
		printf(
			esc_html__( 'Thanks for creating an account on %1$s. Your username is %2$s. You can access your account area to view orders, change your password, and more at: %3$s', 'nh-theme' ),
			esc_html( $blogname ),
	...
	<?php if ( $password_generated && $set_password_url ) : ?>
		<?php // If the password has not been set by the user during the sign up process, send them a link to set a new password. ?>
		<p><a href="<?php echo esc_attr( $set_password_url ); ?>"><?php echo esc_html__( 'Click here to set your new password.', 'nh-theme' ); ?></a></p>
	<?php endif; ?>
