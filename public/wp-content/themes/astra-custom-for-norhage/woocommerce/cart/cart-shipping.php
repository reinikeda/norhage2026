 ...
 *
 * Norhage: always output a radio so the method <label for> targets a
 * labelable control. Woo uses a hidden input when only one method exists,
 * which Chrome reports as an invalid label.
 *
