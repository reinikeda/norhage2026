...
/**
 * =============================================
 * CUSTOM SHIPPING ESTIMATOR FOR SIDE CART
 * =============================================
 */
...
function cse_enqueue_assets() {
	...
	wp_localize_script( 'cse-script', 'cse_params', array(
		...
		'i18n'     => array(
			'calculating'   => __( 'Calculating…', 'nh-theme' ),
			'calculate'     => __( 'Calculate', 'nh-theme' ),
			'free'          => __( 'Free', 'nh-theme' ),
			'no_methods'    => __( 'No shipping methods available for this postcode.', 'nh-theme' ),
			'error'         => __( 'Something went wrong. Please try again.', 'nh-theme' ),
			'fill_postcode' => __( 'Please enter a postcode.', 'nh-theme' ),
			'fill_country'  => __( 'Please select a country.', 'nh-theme' ),
		),
	) );
}

// AJAX handler — logged in + guests
add_action( 'wp_ajax_cse_calculate_shipping',        'cse_calculate_shipping_ajax' );
