...
class NH_TC_Ajax {
	...
	public static function read_input() {
		...
		return array(
			...
			'material'            => self::pick( $src, 'material', array( 'multiwall' ), 'multiwall' ),
			...
			'connecting_profile'  => self::pick( $src, 'connecting_profile', array( 'clamping', 'h_plastic' ), 'clamping' ),
			'connecting_color'    => self::pick( $src, 'connecting_color', array( 'silver', 'brown', 'anthracite', 'clear', 'bronze' ), 'silver' ),
			'finish_profile'      => self::pick( $src, 'finish_profile', array( 'f_profile', 'u_plastic', 'u_aluminium', 'l_aluminium' ), 'f_profile' ),
